...
resource "aws_eip" "master2" {
  vpc                       = true
  network_interface         = aws_network_interface.master2.id
...
resource "aws_eip" "master3" {
  vpc                       = true
  network_interface         = aws_network_interface.master3.id
...
resource "aws_eip" "indexer1" {
  vpc                       = true
  network_interface         = aws_network_interface.indexer1.id
...
resource "aws_eip" "indexer2" {
  vpc                       = true
  network_interface         = aws_network_interface.indexer2.id
...
resource "aws_eip" "indexer3" {
  vpc                       = true
  network_interface         = aws_network_interface.indexer3.id
...
resource "aws_eip" "search_head_deployer" {
  vpc                       = true
  network_interface         = aws_network_interface.search_head_deployer.id
...
resource "aws_eip" "search_head_1" {
  vpc                       = true
  network_interface         = aws_network_interface.search_head_1.id
...
resource "aws_eip" "search_head_2" {
  vpc                       = true
  network_interface         = aws_network_interface.search_head_2.id
...
resource "aws_eip" "search_head_3" {
  vpc                       = true
  network_interface         = aws_network_interface.search_head_3.id
